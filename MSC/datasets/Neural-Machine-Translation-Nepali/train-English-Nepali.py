...
def main(args):
    ...
    # Save the vocabs
    data_module.input_lang.save_to_file("vocab_eng_to_nep/input_vocab.json", input=True)
    data_module.output_lang.save_to_file("vocab_eng_to_nep/output_vocab.json", input=False)
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor='val_loss',
        dirpath="./saved_checkpoint_eng_to_nep/",
...
if __name__ == '__main__':
  ...
  # -hs 128 -nl 2 -mt lstm --attention --bidirection
    ...
    ### English to Nepal
  #    python3 train-English-Nepali.py \
  # -d cuda -w 0 -g 1 -db False \
  # --input_lang np --output_lang en \
