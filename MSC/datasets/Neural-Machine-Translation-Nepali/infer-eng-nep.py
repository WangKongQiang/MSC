...
# ✅ I. inference script: infer-eng-nep.py
...
if __name__ == "__main__":
    ...
    # python infer-eng-nep.py \
    # --checkpoint saved_checkpoint_eng_to_nep/nmt-epoch=18-val_loss=2.436-val_quad_bleu=0.000.ckpt \
    # --input_vocab vocab_eng_to_nep/input_vocab.json \
    # --output_vocab vocab_eng_to_nep/output_vocab.json \
    # --hidden_size 128 \
    # --num_layers 2 \
    # --max_len 16 \
    # --attention \
